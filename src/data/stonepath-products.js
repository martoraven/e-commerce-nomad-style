...
export const stonepathProducts = [
  ...
  {
    id: 345,
    title: "STONEPATH Retro Handheld",
    price: 99.0,
    imgSrc:   `${base}/retro-handheld/main.png`,
    imgHover: `${base}/retro-handheld/hover.png`,
    gallery: gallery("retro-handheld"),
    colorOptions: [
      { id: "retro-handheld-natural", value: "Natural", color: "beige" },
    ],
    colors: [
      { bgColor: "bg-brown", imgSrc: `${base}/retro-handheld/color-natural.png` },
    ],
    category: "Gadgets",
    vendor: "STONEPATH",
    description: "A pocket-sized handheld built for the golden era of gaming. The 3.5\" IPS screen and tactile D-pad bring 8-bit and 16-bit classics back the way they were meant to be played, powered by an open-source emulation system with support for over a dozen retro platforms. HDMI output lets you take it to the big screen, and the 3000 mAh battery delivers around 6 hours of play. MicroSD slot included — bring your own game library.",
    inStock: true,
    filterBrands: ["STONEPATH"],
    filterColor: ["Natural"],
    filterSizes: [],
...
export const stonepathTestimonials = [
  ...
  },
  {
    id: 345,
    imgSrc: `${base}/retro-handheld/main.png`,
    alt: "STONEPATH Retro Handheld",
    quote:
      "Bought it on a nostalgia impulse and it exceeded every expectation. The screen is sharp, the buttons feel like the real thing, and setup took five minutes. My kids now fight me for it — that says everything.",
    author: "Nathan W.",
